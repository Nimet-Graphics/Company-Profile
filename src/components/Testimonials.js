...
const Testimonials = () => {
  const testimonials = [
    ...
    },
    {
      ...
      name: 'Abdulhakim J.',
      role: 'Print Operator',
      testimonial: 'Warm greeting for Nimet Graphics Designers. I find myself reflecting on all the reasons I\'m grateful, and one of the highlights of this year has been your exceptional Graphics Service.',
      image: test3,
    },
    {
      link: 'https://www.google.com/search?client=opera&q=nimet+graphics&sourceid=opera&ie=UTF-8&oe=UTF-8#',
      name: 'Lidia W.',
      role: 'Makeup Artist',
      testimonial: 'Delivers high-quality business card designs with excellent attention to detail and a keen understanding of my needs! Thanks',
      image: test1,
    },
  ];
